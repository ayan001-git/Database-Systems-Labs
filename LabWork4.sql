-- ==========================================
-- LabWork4 – SQL Queries, Functions, Operators
-- ==========================================
-- Database: lab4
-- ==========================================
...
-- ==========================================
-- PART 2: WHERE CLAUSE AND OPERATORS
-- ==========================================
-- Task 2.1
SELECT * FROM employees
...
-- ==========================================
-- PART 3: STRING AND MATH FUNCTIONS
-- ==========================================
-- Task 3.1
SELECT UPPER(first_name || ' ' || last_name) AS name_upper,
       LENGTH(last_name) AS last_name_length,
       SUBSTRING(email FROM 1 FOR 3) AS email_start
FROM employees;
...
SELECT first_name, last_name,
       ...
       salary * 0.1 AS raise_10_percent
FROM employees;
...
SELECT department,
       ...
       GREATEST(AVG(salary), MIN(salary)) AS greatest_check,
       LEAST(MAX(salary), AVG(salary)) AS least_check
FROM employees
WHERE salary = (SELECT MAX(s.salary) FROM employees s WHERE s.department = employees.department)
